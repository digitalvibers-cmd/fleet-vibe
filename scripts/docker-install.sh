...
update_override_with_yq() {
  yq -i "
    ...
    .services.application.environment.CONSOLE_HOST    = \"$SCHEME_CONSOLE://$HOST:4205\" |
...
services:
  application:
    environment:
      APP_KEY: "$APP_KEY"
      CONSOLE_HOST: "$SCHEME_CONSOLE://$HOST:4205"
...
{
  "API_HOST": "$SCHEME_API://$HOST:8005",
  "SOCKETCLUSTER_HOST": "$HOST",
  "SOCKETCLUSTER_PORT": "38005",
